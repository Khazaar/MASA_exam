...
export const classNames: string[] = [Mathematics, Hebrew, Geography, History, Chemistry, Physics]
export const Professions: string[] = [Mathematics, Hebrew, Geography, History, Chemistry, Physics]
